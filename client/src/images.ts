...
// To change any photo on the site, find the section below and swap the URL.
...
export const gallery: string[] = Object.values(galleryGlob) as string[];
...
// ─── Services (used in const.ts SERVICES array) ──────────────────────
...
// ─── Crew (used in const.ts CREW array) ──────────────────────────────
