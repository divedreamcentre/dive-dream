...
import { DIVE_PACKAGES, COURSES, SERVICES } from '@/const';
...
export default function Reservations() {
  ...
  const getSelectionLabel = () => {
    ...
    if (serviceCategory === 'packages') {
      return `Package: ${DIVE_PACKAGES.find(p => p.id === selectedOption)?.name}`;
    }
                ...
                <div className="glass-panel p-8 md:p-10">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-sm font-bold uppercase tracking-wider text-primary pb-2 border-b border-white/5">Personal Info</h3>
                    ...
                    {/* Section 2: Itinerary */}
                    <div className="space-y-4">
                      <h3 className="text-sm font-bold uppercase tracking-wider text-primary pb-2 border-b border-white/5">Itinerary</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex flex-col space-y-1.5">
